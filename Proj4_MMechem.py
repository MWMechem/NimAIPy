...
"""Madeline Mechem, AI Project 4, Python code
So in doing this over two different languages, I learned that
it is much easier to relearn old python than new c++.

That being said, this code takes user input and turns it into what I hope is
correct Q-learning."""

#also this breaks for small numbers of simulations.
        ...
        while board != "A000"  and board != "B000":
            ...
            if (board[0] == 'A'):
                ...
                if int(b) > 0:  
                    i = 0                   
                    while i < int(b):
                        nextstate = a + b + c + d + '0' + str((int(b)-i))
                        i += 1
                ...
                if int(c) > 0:                   
                    i = 0                   
                    while i < int(c):
                        nextstate = a + b + c + d + '1' + str((int(c)-i))
                        i += 1
                        if nextstate in qtable:
                            if minv > qtable[nextstate]:
                                minv = qtable[nextstate]                
                if int(d) > 0:
                    i = 0                   
                    while i < int(d):
                        nextstate = a + b + c + d + '2' + str((int(d)-i))
                        i += 1
                        if nextstate in qtable:
                            if minv > qtable[nextstate]:
                                minv = qtable[nextstate]                            
